...
def main():
    ...
    # Com o RLock() não terá os erros com mais de uma thread e funcionará corretamente embora leva mais tempo
    tarefas = [    
    ...
    print("Transferências finalizadas.")
...
def valida_banco(contas: List[Conta], total: int):
    ...
    if atual != total:
        ...
        print(f"Transação Ok: Balanço Bancário Consistente. BRL$ {total:.2f}", flush=True)
