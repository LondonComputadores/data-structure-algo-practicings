...
# Começa a solução por essa função e depois cria a função acima, o print 
# e o if na linha acima
def torre_de_hanoi(numero_de_discos: int):
    global contagem_de_chamadas_recursivas
    contagem_de_chamadas_recursivas = 0
    _torre_de_hanoi_recursivo(numero_de_discos, 
                                        origem='A', destino='B', auxiliar='C')
